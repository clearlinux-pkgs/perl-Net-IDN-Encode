...
Source0  : https://cpan.metacpan.org/authors/id/C/CF/CFAERBER/Net-IDN-Encode-2.401.tar.gz
...
%prep
%setup -q -n Net-IDN-Encode-2.401
cd ..
%setup -q -T -D -n Net-IDN-Encode-2.401 -b 1
mkdir -p deblicense/
mv %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Net-IDN-Encode-2.401/deblicense/
